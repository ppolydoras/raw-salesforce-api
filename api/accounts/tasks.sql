...
-- @param task_subject the subject of the task related to a given account. Substring search is supported.
-- @type task_subject varchar
-- @default task_subject null
-- @param task_id the ID of the task related to a given account.
...
-- @return tasks related to accounts based on filters like account name, task subject, and status.

WITH filtered_account_tasks AS (
